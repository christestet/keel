...
| [0043](0043-implicit-package-capability-trust-anchor.md) | Implicit packages are the capability trust anchor; `keel audit` reports derived capabilities | proposed |
