...
| 19 | OCI image build (`keel build --image`) | [KDR-0107](../kdr/0107-oci-image-build.md), [KDR-0108](../kdr/0108-image-arch-selection.md) — **implemented** (incl. `--arch` selection), see [`19-oci-images.md`](19-oci-images.md) |
