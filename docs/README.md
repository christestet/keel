...
3. [`kdr/INDEX.md`](kdr/INDEX.md) — decision records (KDRs), accepted and rejected
4. [`compiler/ARCHITECTURE.md`](../compiler/ARCHITECTURE.md) — compiler pipeline, crate layout, iron rules
...
| [`spec/`](spec/) | Normative language specification. `keel-core.md` is the frozen subset; chapters `01-`, `04-` add tested detail. |
